...
public class IntentUtils {
    ...
    public static void openGalery(Activity activity, int requestCode) {
        try {
            ...
            LogUtils.d(LOG_TAG, "open default gallery app error: " + ex.getMessage());
    ...
    public static void openCameraApp(Activity activity, int requestCode) {
        try {
            ...
            LogUtils.d(LOG_TAG, "open default gallery app error: " + e.getMessage());
        }
    }
    ...
    public static void openPhoneCall(Activity activity, String phone) {
        ...
        try {
            ...
            LogUtils.d(LOG_TAG, "open phone call error: " + e.getMessage());
        }
    }
    ...
    public static void openBrowser(Activity activity, String url) {
        ...
        try {
            ...
            LogUtils.d(LOG_TAG, "open browser error: " + e.getMessage());
        }
    }
    ...
    public static void openSendSms(Context context, String message) {
        try {
            ...
            if (e != null)
                LogUtils.d(LOG_TAG, "openSendSms error: " + e.getMessage());
        }
    }
    ...
    public static boolean startTargetShareIntent(Context context, String targetPackageName, String textMessage) {
        ...
        if (!resInfos.isEmpty()) {
            for (ResolveInfo resInfo : resInfos) {
                ...
                LogUtils.d(LOG_TAG, "package: " + packageName);
