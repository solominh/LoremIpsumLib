...
//            adapter.setLogLevel(RestAdapter.LogLevel.FULL);
        ...
        if (response == null) {
            ...
            if (error.isNetworkError()) {
                if (error.getCause() instanceof SocketTimeoutException) {
                    ...
                    LogUtils.e(LOG_TAG, tempMessage);
    ...
    public static int handleRetrofitError(Activity activity, final RetrofitError retrofitError, String message, boolean isToastMessage) {
        ...
        if (authError) {
            ...
            try {
                ...
                clazz = null;
                LogUtils.e(LOG_TAG, "Unable to find class " + myClass + ". Did you include it in AndroidManifest? or use full package path?");
            }
            if (clazz != null) {
        ...
        if (retrofitError != null) {
            LogUtils.e(LOG_TAG, retrofitError.getUrl());
    ...
    public static class RetrofitErrorMsg {
        private int statusCode;
        private String errorMessage;

        public RetrofitErrorMsg(int statusCode, String errorMessage) {
    ...
    public static RetrofitErrorMsg handleRetrofitError(Activity activity, final RetrofitError retrofitError, String message) {
        ...
        if (authError) {
            ...
            if (clazz != null) {
                ...
                activity.overridePendingTransition(R.anim.slide_right_to_left, R.anim.slide_left_to_right);
                activity.finish();
                return new RetrofitErrorMsg(statusCode, errorMsg);
            }
        }
        ...
        return new RetrofitErrorMsg(statusCode, message);
    }
