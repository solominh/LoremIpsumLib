        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    LogUtils.d(logTagClass, logTagMethod + " error: " + message);
                    LogUtils.e(logTagClass, logTagMethod + " error: " + message);
                    object = null;
                    ...
                    if (object == null) {
                        if (context instanceof Activity) {
                            ...
                            LogUtils.e(logTagClass, "Context passed to API call is not Activity class");
                        }
                    } else {
