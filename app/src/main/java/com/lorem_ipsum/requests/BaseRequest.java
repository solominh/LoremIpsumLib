...
public class BaseRequest {
    ...
    private static final String DEVELOPMENT_API_VERSION_STRING = "/staging";
    private static final String PRODUCTION_API_VERSION_STRING = "/v1";
    ...
    public static String getBaseUrl(int appStatus, boolean withPrefix) {
        ...
        if (withPrefix) {
            switch (appStatus) {
                case DEVELOPMENT:
                    builder.append(DEVELOPMENT_API_VERSION_STRING);
                    break;

                case PRODUCTION:
                    builder.append(PRODUCTION_API_VERSION_STRING);
                    break;
            }
        }
    ...
    public static HashMap<String, String> getStandardHeaderParameters() {
        ...
        String key = UserSessionDataManager.getLicenseKey();
